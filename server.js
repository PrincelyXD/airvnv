...
createServer({
    ...
    seeds(server) {
        ...
        server.create("user", { id: "123", email: "princelykweks@gmail.com", password: "yogadomingo", name: "PrincelyX" })
    },
    ...
    routes() {
        ...
        this.post("/login", (schema, request) => {
            ...
            // consider this professional, it is for testing purposes and demonstration😇
